      ...
      <div className="min-h-screen bg-white">
        <div className="p-4">
          ...
          <div className="bg-system-blue-light rounded-lg p-6 mb-6">
            ...
            {isLoading ? <div className="h-10 w-48 bg-blue-400 animate-pulse rounded-md mb-4"></div> : <p className="text-white text-4xl font-bold mb-4">₦{(stats?.withdrawable_balance || 0).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>}
            <button
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3 mb-6">
                <div className="bg-green-50 rounded-lg p-4">
                  ...
                  <p className="text-xl font-bold text-gray-900">₦{(stats?.available_balance || 0).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
                </div>

                <div className="bg-yellow-50 rounded-lg p-4">
                  <p className="text-xs text-gray-600 mb-1">Pending Balance</p>
                  <p className="text-xl font-bold text-gray-900">₦{(stats?.pending_balance || 0).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
                </div>

                <div className="bg-purple-50 rounded-lg p-4">
                  <p className="text-xs text-gray-600 mb-1">Total Earnings</p>
                  <p className="text-xl font-bold text-gray-900">₦{(stats?.total_earnings || 0).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
                </div>
                ...
                <div className="bg-purple-50 rounded-lg p-4">
                  ...
                  <p className="text-xl font-bold text-gray-900">₦{(stats?.this_month_earnings || 0).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="bg-indigo-50 rounded-lg p-4">
                  ...
                  <p className="text-xl font-bold text-gray-900">₦{(stats?.total_credits || 0).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
                </div>
                <div className="bg-red-50 rounded-lg p-4">
                  <p className="text-xs text-gray-600 mb-1">Total Debits</p>
                  <p className="text-xl font-bold text-gray-900">₦{(stats?.total_debits || 0).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
                </div>
              </div>
            </div>
          )}
