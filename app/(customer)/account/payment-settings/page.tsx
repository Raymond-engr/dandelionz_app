...
export default function CustomerPaymentSettingsPage() {
      ...
      <div className="min-h-screen bg-white">
        ...
        <div className="p-6">
          ...
          <div className="mb-8">
            ...
            >
              <span className="text-sm font-medium text-gray-900">Payout Details</span>
          ...
          <div>
            ...
            <Link
              ...
              className="flex items-center justify-between px-0 py-4 hover:bg-gray-50 transition-colors"
            >
              <span className="text-sm font-medium text-gray-900">Payment PIN</span>
              <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
              </svg>
            </Link>
